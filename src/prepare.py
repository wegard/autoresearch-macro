...
SSB_SERIES_CONFIG: dict[str, dict[str, Any]] = {
    ...
    "industrial_production": {
        "table_id": "07095",
        "description": "Manufacturing production index, seasonally adjusted (2021=100)",
        "selections": {
            "PKoder": ["P105"],
            "ContentsCode": ["Sesongjustert"],
        },
        "frequency": "monthly",
        # Migrated from table 14208 on 2026-04-14: 14208 stopped publishing
        # in 2023M12 and was superseded by 07095, which uses the same PKoder/
        # ContentsCode codes but a 2021=100 base year instead of 2005=100.
        # Dynamics are identical; absolute levels differ by a multiplicative
        # rebase. Historical forecast_errors.parquet was computed on 14208
        # and is not regenerated by this change.
    },
    "retail_sales": {
        "table_id": "07129",
